...
CREATE TABLE IF NOT EXISTS `BurgerCity`.`Orders` (
  ...
  PRIMARY KEY (`orderId`),
  INDEX `fk_Orders_Adress1_idx` (`deliveryAdressId` ASC),
  INDEX `fk_Orders_Account1_idx` (`customerId` ASC),
...
CREATE TABLE IF NOT EXISTS `BurgerCity`.`OrderItems` (
  ...
  INDEX `fk_OrderItems_Products1_idx` (`productid` ASC),
  INDEX `fk_OrderItems_Orders1_idx` (`orderId` ASC),
...
CREATE TABLE IF NOT EXISTS `BurgerCity`.`AdressHelper` (
  ...
  INDEX `fk_AdressHelper_Adress1_idx` (`addressId` ASC),
  INDEX `fk_AdressHelper_Account1_idx` (`Account_accountId` ASC),
...
CREATE TABLE IF NOT EXISTS `BurgerCity`.`ProductHelper` (
  ...
  INDEX `fk_ProductHelper_Products1_idx` (`productId` ASC),
  INDEX `fk_ProductHelper_Ingedients1_idx` (`ingredientsId` ASC),
